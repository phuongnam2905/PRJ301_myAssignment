		   ...
		   <div class="col-sm-9">
                    <div>
                        ...
                        <form action="/QLSV/Mon_servlet" method="POST" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tenlop" class="form-control" id="" placeholder="Thêm tên môn">
                            </div>
                        ...
                        <form action="/QLSV/Mon_servlet" method="POST" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="search" class="form-control" id="" placeholder="Nhập tên môn hoặc mã">
                            </div>
                    ...
                    <div>
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <%
                                    ArrayList<MonHoc_DTO> list = new Mon_Model().get_all();
