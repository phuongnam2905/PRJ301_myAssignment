...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div>
                        <h2>Thêm bảng điểm mới</h2>
                        <form action="/QLGV/BangDiem_servlet" method="POST" role="form">
                        <div class="form-group">
                            <label for="">Chọn lớp</label>
                            <select class="form-control" name="idlop" id="idmon" onchange="chonhs()">
                                <%
                                    ArrayList<Lop_DTO> ds_lop = new Lop_Model().get_all();
                                    for (Lop_DTO items : ds_lop) {
                                %>
                            ...
                            <select class="form-control" name="idhs">
                                <%ArrayList<HocSinh_DTO> ds_hs = new HocSinh_Model().get_all();
                                    for (HocSinh_DTO items : ds_hs) {
                                %>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=items.getDiem()%></td>
                                        <td><a href="/QLGV/Admin/QLBangDiem/Sua.jsp?id_bd=<%=items.getBD_ID()%>">Sửa</a>
                                            <a href="/QLGV/BangDiem_servlet?id_bd=<%=items.getBD_ID()%>">Xóa</a>
                                        </td>
                                    </tr>
                                    <% }%>
                                </tbody>
