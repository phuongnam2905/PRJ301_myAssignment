	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="col-sm-12">
                    <div>
                        ...
                        <%
                            Lop_DTO lop = new Lop_Model().select_by_id(request.getParameter("id_lop"));
                        %>
                        <form action="/QLSV/Lop_servlet" method="POST" role="form">
                            <legend></legend>

                            <div class="form-group">
                                <input type="hidden" value="<%=lop.getLop_ID()%>" name="id">
                                <label for="">Tên lớp</label>
                                <input type="text" name="tenlop" class="form-control" id="" value = "<%=lop.getTenLop()%>" placeholder="Thêm tên lớp">
                                <label for="">Sỉ số</label>
                                <input type="text" name="siso"  value = "<%=lop.getSiSo()%>" class="form-control" id="" placeholder="Thêm tên lớp">
                            </div>
